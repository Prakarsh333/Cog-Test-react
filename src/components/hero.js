...
const Hero = () => {
  return (
    <>
    <section class="bg-gradient-to-r from-gray-900 from-10% via-gray-500 via-30% to-gray-900 to-90% ... text-black">
  <div class="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-1/2 lg:items-center">
    <div class="mx-auto max-w-3xl text-center">
      <h1
        class="bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-clip-text text-3xl font-extrabold text-transparent sm:text-5xl"
      >
        Welcome to Cog-Sci Lab

        <span class="sm:block"> InIIT-H </span>
      </h1>
